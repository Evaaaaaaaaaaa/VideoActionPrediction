...
def display_acc(results, is_goal):
    ...
    if is_goal:
        print("Model 2", "Goal Accuracy: ")
    else:
        print("Model 2", "Action Accuracy: ")
    for i in range(9):
...
def run_model():
    ...
    transformer_action_acc, transformer_goal_acc = cross_validation(all_split_x, all_split_y_action, all_split_y_goal, wo_transformer)
