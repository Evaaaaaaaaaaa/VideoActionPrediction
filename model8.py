...
def lstm_model(max_action_len):
    ...
    i2 = tf.concat([i1, o1_repeat], -1)
    # o2 = LSTM(8, return_sequences=True)(i2)
    # o2 = LSTM(16,return_sequences=True)(o2)
    o2 = LSTM(128,return_sequences=False)(i2)
    o2 = Dense(47, activation="softmax")(o2)
    model = Model(inputs=[i1], outputs=[o2, o1])
...
def tcn_model(max_action_len):
    ...
    # o2 = LSTM(8, return_sequences=True)(i2)
    # o2 = LSTM(16,return_sequences=True)(o2)
    o2 = TCN(128, return_sequences=False)(i2)
    o2 = Dense(47, activation="softmax")(o2)
    model = Model(inputs=[i1], outputs=[o2, o1])
