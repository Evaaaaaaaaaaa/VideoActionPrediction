...
# 6. test on changing masking layer to input layer
...
from keras.layers import Dropout, Masking, TimeDistributed


def lstm_model(max_action_len):
    model = Sequential()
    model.add(LSTM(512, input_shape=(max_action_len, 57), return_sequences=True))  # todo
